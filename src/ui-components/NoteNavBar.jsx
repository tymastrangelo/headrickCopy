...
export default function NoteNavBar(props) {
  const { nav, overrides, ...rest } = props;
  ...
  return (
    ...
    >
      <Flex
        ...
        {...getOverrideProps(overrides, "Logo40472314")}
      >
        <Icon
          width="18px"
          height="18px"
          ...
          shrink="0"
          position="relative"
          {...getOverrideProps(overrides, "Star 140472315")}
        ></Icon>
      </Flex>
      <Flex
        gap="40px"
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Logo4060659")}
      >
        <Icon
          width="18px"
          height="18px"
          ...
          shrink="0"
          position="relative"
          {...getOverrideProps(overrides, "Star 14060660")}
        ></Icon>
      </Flex>
    </Flex>
  );
